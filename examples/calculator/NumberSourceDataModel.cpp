...
QJsonObject NumberSourceDataModel::serialize() const {
    QJsonObject modelJson = NodeDataModel::serialize();
...
void NumberSourceDataModel::unserialize(QJsonObject const &p) {
